...
const EnterOtp: React.FC = () => {
    ...
    const handleVerifyOtp = async () => {
        ...
        try {
            const response = await axios.post('https://picbackend.onrender.com/verify-otp', { email, otp });
    ...
    const handleResendOtp = async () => {
        ...
        try {
            const response = await axios.post('https://picbackend.onrender.com/resend-otp', { email });
